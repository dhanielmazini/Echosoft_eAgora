...
public class TelaDeRedirecionamentoMainActivity extends AppCompatActivity {
    ...
    /*    TextView EVENTO = (TextView)findViewById(R.id.EVENTO);
       ...
       /* //eventbtn.setX(55);
        ...
        PONTOS.setX(230);
        PONTOS.setY(1300);*/
        bar_e_restaurante.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
        ...
        pontos_turisticos.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent intentpts = new Intent(getApplicationContext(), PontosTuristicosActivity.class);
